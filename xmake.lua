...
-- Project definition
set_project("FlacCodec")
set_version("0.5.0")
set_license("Apache-2.0")
set_languages("c++20")
set_description("The official Amplitude plugin to encode and decode FLAC audio files.")
set_xmakever("3.0.0")
...
target("FlacCodec")
  set_kind("shared")
  set_default(true)
  set_basename("AmplitudeCodecFlac")
  ...
  add_packages("amplitudeaudiosdk", "libflac")
